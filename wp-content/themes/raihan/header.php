        ...
        <div class="container-fluid" style="width: 93%;">
            ...
            <div class="row top-bar-1">
                <div class="col-lg-3  d-lg-block d-none mt-3  ">
                    <div>
                        <!-- Contact Number -->
                        <a href="<?= get_option( 'my_options' )['contact_number'] ?? ''; ?>">
                            <span class="bi bi-telephone   top-icon1">
                            <?= get_option( 'my_options' )['contact_number'] ?? ''; ?>
                            </span>
                        </a>
                    </div>
                    <div class="pt-2">
                        <!-- Email Address -->
                        <a href="<?= get_option( 'my_options' )['email_address'] ?? ''; ?>">
                            <span class="bi bi-envelope   top-icon1">
                            <?= get_option( 'my_options' )['email_address'] ?? ''; ?>
                            </span>
                        </a>
                    </div>
                </div>
